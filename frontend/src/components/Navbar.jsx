...
const Navbar = () => {
  ...
  return (
    ...
    transisiton-all duration-300 border-b border-emerald-800'>
        ...
        <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
                ...
                ease-in-out">
                    ...
                    text-xs group-hover:bg-emerald-400 transition duration-300 ease-in-out">3</span>
                </Link>
            )}
            {isAdmin && (
            ...
            {user ? (
                ...
                <>
                  ...
                  <UserPlus className="ml-2" size={18}></UserPlus>
                    Sign Up
                  </Link>
                  <Link to={"/login"} className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 
                  rounded-md flex items-center transition duration-300 ease-in-out">
                  <LogIn className="ml-2" size={18}></LogIn>
                    Login
                  </Link>
                </>
            )}
